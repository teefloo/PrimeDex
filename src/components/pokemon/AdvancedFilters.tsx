    ...
    <Sheet>
      ...
      <SheetContent className="w-full sm:max-w-md bg-background/95 backdrop-blur-2xl border-l border-white/10 flex flex-col p-0">
        ...
        <ScrollArea className="flex-1 px-6 py-4">
          <div className="space-y-10 pb-10">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-secondary/20 rounded-2xl border border-white/5">
                <div className="flex flex-col gap-0.5">
                  <span className="text-sm font-bold">Legendary Pokémon</span>
                  <span className="text-[10px] text-foreground/40 font-medium">Show only legendaries & mythicals</span>
                </div>
                <Switch 
            ...
            <div className="space-y-6">
              ...
              <Slider
                value={[minBaseStats]}
                onValueChange={(val) => setMinBaseStats(val[0])}
                max={800}
                step={10}
                className="py-4"
              />
        ...
        <SheetFooter className="p-6 border-t border-white/5 bg-background/50">
          <SheetClose asChild>
            <Button className="w-full h-14 rounded-2xl font-black uppercase tracking-widest text-sm shadow-[0_8px_30px_rgb(255,50,50,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all">
              Apply Filters
            </Button>
          </SheetClose>
        </SheetFooter>
